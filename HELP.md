...
* The original package name 'net.javaguides.springboot-restful-webservices' is invalid and this project uses 'net.javaguides.springboot_restful_webservices' instead.
